...
<body>
				...
				<div class="row">
					...
					<div class="col-sm-6 col-md-6 col-lg-4">
						<div class="info">
							...
							<div class="right-area">
								<h5>marian.guerra@g.batstate-u.edu.ph</h5>
    ...
    <section class="intro-section" style="background-image: url(/img/Marian-cover.jpg);">
		<div class="container">
			<div class="row">
				<div class="col-md-1 col-lg-2"></div>
				<div class="col-md-10 col-lg-8">
					<div class="intro">
                                            <div class="profile-img"><img src="/img/Marian.jpg" alt=""></div>
                                            <h2><b>Marian Guerra</b></h2><br>
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    ...
                    <ul>
                        ...
                        <li><a href="Marian.php">Marian Guerra</a></li>
                        <li><a href="Mariel.php">Mariel Guerra</a></li>
                    </ul>
                </div>
                <div>
                    <h5>Support</h5>
